...
var user2 = {
  ...
  lastname: "Fender",
  url:
    "https://raw.githubusercontent.com/ahle-pro/sbt-bot/master/docs/www/images/user2.jpg"
};

var bot = {
  designer:
    "https://raw.githubusercontent.com/ahle-pro/sbt-bot/master/docs/www/images/team.png"
};
...
function addImage(opts) {
  return new Promise(function(resolve, reject) {
    setTimeout(function() {
      $(
        '<div class="botui-message">\n                <div class="botui-message-content image ' +
          opts.cssClass +
          '"><img class="botui-message-content-image" src="' +
          opts.url +
          '" /></div>\n            </div>'
      )
        .hide()
        .appendTo("div.botui-messages-container")
        .fadeIn(500);
      resolve();
    }, 500);
  });
...
function init3() {
  var texts = [
    "Bot initialization: please enter values ​​for this demo",
    "The location of the recipient in Italy (city)"
  ];
...
function connection() {
  ...
  if (firstRun) {
    ...
    user1.taskDone =
      (user1.completed.no62 || user1.transfered.no62) &&
      (user1.completed.no64 || user1.transfered.no64);
    if (user1.taskDone) {
      connection3();
    } else {
      connection2();
...
function connection1() {
  var texts = [
    ...
    "Happy to be able to exchange with you a few moments.",
    "According to my information, you are a Store Planner for Italy, with Emilia Prescci."
  ];
...
function connection3() {
  var texts = [
    "Good news! The remaining points around Rome Etoile store were handled by " +
      user2.firstname +
      " " +
      user2.lastname +
      "!",
    "No more delayed questions",
    "\uD83D\uDC51"
  ];
  sendTexts(texts, function() {
    exit0({ type: 3 });
...
function check3() {
  var texts = [
    "Sorry, but the location saved for you does not match.",
    "Try a second time"
  ];
...
function check5() {
  var texts = [
    ...
    "Please enter a password to save time on your next connections"
  ];
...
function intro1() {
  addImage({ url: user2.url })
    .then(function() {
      var texts = [
        "Your contact was sent to us directly by Emilia Prescci, but also by " +
          user2.firstname +
          " " +
          user2.lastname +
          " who works with you."
    ...
    .then(function() {
      var texts1 = [
        "For my part, I am a bot at your service, as the team who designed me and who can exchange with you if you need assistance."
      ];
      return botui.message.add({
        delay: 1000,
        loading: true,
...
function store1_3() {
  ...
  var texts = [
    "Nice!",
    "Together, we have to investigate " +
      nPoints +
      " points of the checklist that have not been covered yet."
  ];
  var choices = [
    {
...
function store1_4() {
  var texts = [
    "I am very strong as a robot to recall lists 😉",
    "Which point do you wish to address?"
  ];
  var choices = [
    {
...
function no6() {
  var texts = [
    "A good part of the effort on power consumption comes from the limitation of the usage that can be planned, programed, or organized.",
  ...
  sendTexts(texts, function() {
    ...
    botui.action
      ...
      .then(function(response) {
        switch (response.value) {
          case "yes":
            addImage({ url: "images/store161.png", cssClass: "human" }).then(
              function() {
                no6_4();
              }
            );
...
function no6_4() {
  ...
  var texts = [
    "OK! Let's continue with planning and programing",
  ...
  sendTexts(texts, function() {
    botui.action
      ...
      .then(function(response) {
        switch (response.value) {
          case "yes":
            addImage({ url: "images/store162.jpg", cssClass: "human" }).then(
              function() {
                exit0({ type: 1 });
              }
            );
...
function not6() {
  var texts = [
    "Sorry, I'm a poor lonesome bot, not yet programed to deepen these points on which I ask you yet!",
    "😅",
    "Please try point No.6"
  ];
  var choices = [
    {
...
function answerAnyway() {
  var texts = [
    "Sorry, not ready for this task yet.",
    "Keep in mind that I am a prototype",
    "🐣"
  ];
  var choices = [
    {
...
function assistance() {
  var texts = [
    "I'll be the most zealous bot, in connection with a human team.",
    "We will be able to detail the questions and answers.",
    "But for now, I'm not willing to help.",
    "😇"
  ];
...
function differ() {
  var texts = [
    "You will have to postpone the idea to postpone for this demo!",
    "⏲️"
  ];
...
function exit0(args) {
  ...
  switch (args.type) {
    case 1:
      texts = [
        "Thank you! We have no other questions for you at the moment, but I will not fail to contact you for some additional information.",
        "🤖"
      ];
      break;
    case 2:
      texts = [
        "I understand... I will do much better next time! Thank you for this exchange.",
        "🤖"
      ];
    ...
    case 3:
      texts = [
        "I will not fail to contact you for some additional information. See you soon.",
        "🤖"
      ];
      break;
  }
